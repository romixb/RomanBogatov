...
//    8. Assert that there are 4 texts on the Index Page under icons and they have proper text
        ...
        softAssert.assertEquals(webElement.get(0).getText(), EXPECTED_TEXT.get(0));
        softAssert.assertEquals(webElement.get(1).getText(), EXPECTED_TEXT.get(1));
        softAssert.assertEquals(webElement.get(2).getText(), EXPECTED_TEXT.get(2));
        softAssert.assertEquals(webElement.get(3).getText(), EXPECTED_TEXT.get(3));
